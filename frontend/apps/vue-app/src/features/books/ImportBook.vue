        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            <input
              ...
              "
              class="border-input bg-page text-ink placeholder:text-muted/70 focus:ring-accent/20 w-full rounded-2xl border px-5 py-4 pr-14 font-mono text-base transition-[border-color,box-shadow] duration-200 focus:ring-2 focus:outline-none"
              :class="
                hasFieldError
            ...
            >
              ...
              <svg
                ...
                :class="showKey ? 'opacity-0' : 'opacity-100'"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="2"
              ...
              <svg
                ...
                :class="showKey ? 'opacity-100' : 'opacity-0'"
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke-width="2"
