  ...
  <Teleport to="body">
    <AnimatePresence>
      ...
      <Motion
        ...
        :exit="{ opacity: 0 }"
        :transition="FADE"
        class="fixed inset-0 z-[100] flex items-end justify-center overflow-y-auto bg-black/70 p-0 backdrop-blur-md contain-[layout_paint_scroll_style] sm:items-center sm:p-6"
