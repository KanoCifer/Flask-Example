  ...
  <section v-if="hasData" class="mb-14">
    ...
    <Teleport to="body">
      ...
      >
        <div
          v-if="tooltipCell"
          class="bg-page text-ink pointer-events-none fixed z-50 -translate-x-1/2 -translate-y-full rounded-md border px-2.5 py-1.5 text-xs whitespace-nowrap shadow-md"
